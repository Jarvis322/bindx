...
export default function SapOnPremise() {
  return (
    <main className="min-h-screen pt-20">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto">
            <h1 className="text-4xl font-bold mb-6">SAP On-Premise Services</h1>
            <p className="text-xl text-gray-600">
              Comprehensive SAP on-premise solutions for optimal performance, security, and reliability of your local SAP infrastructure.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl font-bold mb-6">Enterprise-Grade On-Premise Solutions</h2>
              <p className="text-gray-600 mb-8">
                Our SAP on-premise services help organizations maintain and optimize their local SAP infrastructure, ensuring maximum performance, security, and business continuity.
              </p>
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">Comprehensive management of your SAP infrastructure and hardware resources.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">Continuous monitoring and optimization of system performance.</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="flex-shrink-0">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">Implementation of robust security measures and access controls.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <p className="text-gray-600">
                Robust backup solutions and disaster recovery planning.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <div className="text-blue-600 mb-4">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Infrastructure and requirements analysis</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">Strategy development and resource allocation</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">Solution deployment and configuration</p>
            </div>
            <div className="text-center">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Optimize Your SAP Infrastructure</h2>
          <p className="text-gray-600 mb-8">
            Contact us to learn how our SAP on-premise services can help you maintain and optimize your local SAP environment.
          </p>
          <Link
            href="/contact"
